...
<figure class = "landscape">
	<img src="{{"/assets/images/2021/11/2022/06/DSC02401-1.jpg" | prepend: site.baseurl | prepend: site.url }}" alt="Image" />
...
<figure class = "landscape" class="landscape|portrait">
	<img src="{{"/assets/images/2021/11/imagename.jpg" | prepend: site.baseurl | prepend: site.url }}" alt="Image" />
	<figcaption><em>Caption</em></figcaption>
</figure>
<figure class = "portrait">
